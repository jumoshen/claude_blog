...
### C端功能
- [x] 内容增强 T1-T9 - 文章分类管理、标签管理、文章搜索、文章置顶/推荐、定时发布、文章目录/大纲导航、上一篇/下一篇文章导航、阅读时间估算、热门/相关文章推荐
- [x] 用户功能 T10-T16 - 用户注册/登录、评论功能、文章点赞、文章收藏
- [x] 传播分享 - 文章分享海报、文章打赏/捐赠、RSS订阅
- [x] 技术优化 T17-T20 - 操作日志、RBAC权限管理
- [x] 阅读进度保存 - localStorage 持久化，关闭页面后重新打开可恢复位置
- [x] 代码复制按钮优化 - MutationObserver 监听内容变化，支持动态渲染的代码块
- [x] PWA 支持 - 添加 pwa-192x192.png 和 pwa-512x512.png 图标

### B端功能
- [x] 管理后台操作日志 - 记录所有管理操作
- [x] 分类管理 - CRUD + 层级分类支持
- [x] 标签管理 - CRUD + 颜色选择器
- [x] 文章编辑器 AI 插入代码块 - 支持 20 种编程语言（golang/python/javascript/shell 等）
- [x] AI 助手完善 - 润色/解释/扩展/续写/生成标题
